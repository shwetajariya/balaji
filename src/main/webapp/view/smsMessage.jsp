					...
					<tr>
						...
						<td colspan="3">
							...
							<c:forEach items="${groups}" var="group">
								<input type="checkbox" id="selectedGroups" name="selectedGroups" value="${group.groupId}"/>${group.groupName}<br/>
						    </c:forEach>
							</div>
						</td>
					</tr><tr>
						...
						<td colspan="3">
							...
							<c:forEach items="${contacts}" var="contact">
								<input type="checkbox" id="selectedContacts" name="selectedContacts" value="${contact.contactId}"/>${contact.contactName}<br/>
						    </c:forEach>
						    </div>
						</td>
					</tr><tr>
						...
						<td><button type="submit" id="postSMSButton">Send SMS</button>
					</tr>
				</table>
			</form>
		</div>

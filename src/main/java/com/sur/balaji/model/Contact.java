...
public class Contact extends ModelBase implements Serializable,
	...
	private Set<ContactGroupMapping> contactGroupMappings = new HashSet<ContactGroupMapping>(
			0);
	...
	public Contact(Department department, Company company,
			Designation designation, User user, Section section,
			String employeeId, String firstName, String lastName,
			Integer priority, String officePhoneNumber, String mobileNumber,
			String residencePhoneNumber, String emailAddress, Date modifiedOn,
			Set<MessageStatus> messageStatuses,
			Set<ContactGroupMapping> contactGroupMappings) {
		...
		this.companyId = this.company == null ? null : this.company
				.getCompanyId();
		this.designationId = this.designation == null ? null : this.designation
				.getDesignationId();
		this.sectionId = this.section == null ? null : this.section
				.getSectionId();
		this.departmentId = this.department == null ? null : this.department
				.getDepartmentId();
	}
	...
	public String getContactName() {
		...
		sb.append(" - ");
		sb.append(this.department == null ? "" : this.department
				.getDepartmentName());
		sb.append(" [");
	...
	public void setContactGroupMappings(
			Set<ContactGroupMapping> contactGroupMappings) {
		this.contactGroupMappings = contactGroupMappings;
	}

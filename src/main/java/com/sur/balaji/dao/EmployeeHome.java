...
import com.sur.balaji.model.Employee;

/**
 * Home object for domain model class Employee.
 * @see com.sur.balaji.dao.Employee
...
public class EmployeeHome {
    ...
    public Employee findById( java.lang.Integer id) {
        ...
        try {
            Employee instance = (Employee) sessionFactory.getCurrentSession()
                    .get("com.sur.balaji.dao.Employee", id);
            if (instance==null) {
    ...
    public List<Employee> findByExample(Employee instance) {
        ...
        try {
            List<Employee> results = (List<Employee>) sessionFactory.getCurrentSession()
                    .createCriteria("com.sur.balaji.dao.Employee")
                    .add( create(instance) )
            .list();

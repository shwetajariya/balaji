...
public class ContactGroupMappingHome {
	...
	private static final Log log = LogFactory
			.getLog(ContactGroupMappingHome.class);
	...
	public ContactGroupMapping merge(ContactGroupMapping detachedInstance) {
		...
		try {
			ContactGroupMapping result = (ContactGroupMapping) sessionFactory
	...
	public ContactGroupMapping findById(ContactGroupMappingId id) {
		...
		try {
			ContactGroupMapping instance = (ContactGroupMapping) sessionFactory
					.getCurrentSession().get(
							"com.sur.balaji.model.ContactGroupMapping", id);
			if (instance == null) {
	...
	public List<ContactGroupMapping> findByExample(ContactGroupMapping instance) {
		...
		try {
			List<ContactGroupMapping> results = (List<ContactGroupMapping>) sessionFactory
					.getCurrentSession()

...
public class ContactAuditHome {
	...
	public ContactAudit merge(ContactAudit detachedInstance) {
		...
		try {
			ContactAudit result = (ContactAudit) sessionFactory
	...
	public ContactAudit findById(ContactAuditId id) {
		...
		try {
			ContactAudit instance = (ContactAudit) sessionFactory
					.getCurrentSession().get("com.sur.balaji.dao.ContactAudit",
							id);
			if (instance == null) {
	...
	public List<ContactAudit> findByExample(ContactAudit instance) {
		...
		try {
			List<ContactAudit> results = (List<ContactAudit>) sessionFactory
					.getCurrentSession()
